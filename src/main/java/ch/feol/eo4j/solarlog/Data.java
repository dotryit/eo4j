...
public class Data {
	...
	public Data(LocalDateTime lastUpdate, double productionPowerAc, double productionPowerDc,
			double consumptionPowerAc) {
	...
	private static LocalDateTime getAsTimestamp(JsonObject properties, String name, DateTimeFormatter formatter)
			throws SolarLogException {
	...
	public String toString() {
		return this.getClass().getSimpleName() + "(lastUpdate=" + lastUpdate + ", productionPowerAc="
				+ productionPowerAc + ", consumptionPowerAc=" + consumptionPowerAc;
	}
